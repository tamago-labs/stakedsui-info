            ...
            <div class=" flex flex-wrap items-center text-xs sm:text-base justify-between mx-auto p-2 w-full">
                <div class="flex ">
                    {/* <TrendingUp
                        className="mr-3"
                    /> */}
                    <Link href="/" class={`self-center font-bold mb-3  text-xl tracking-widest whitespace-nowrap ${cp.className}  bg-gradient-to-r from-blue-100 via-blue-300 to-blue-500 text-transparent bg-clip-text bg-300% animate-gradient`}>
                        StakedSui.info
                    </Link>
                </div>
